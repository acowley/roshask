...
if("FALSE" STREQUAL "TRUE")
  set(actionlib_msgs_SOURCE_PREFIX /tmp/buildd/ros-hydro-actionlib-msgs-1.10.6-0raring-20140617-0424)
  set(actionlib_msgs_DEVEL_PREFIX /tmp/buildd/ros-hydro-actionlib-msgs-1.10.6-0raring-20140617-0424/obj-x86_64-linux-gnu/devel)
  ...
  set(actionlib_msgs_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'actionlib_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
